...
class TabBarPage3 extends StatefulWidget {
  @override
  State<TabBarPage3> createState() => _TabBarPage3State();
}
...
class _TabBarPage3State extends State<TabBarPage3> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('products').where('gornusi', isEqualTo: 'products1').snapshots(),
  ...
  dynamic exportExcel(AsyncSnapshot<QuerySnapshot<Object?>> streamSnapshot) {
    Sheet sheetObject = excel["products1".tr];
    ...
    for (int i = 0; i < streamSnapshot.data!.docs.length; i++) {
      ...
      cell4.value = "Wagtlayyn_harytlar";
    }
    var fileBytes = excel.save(fileName: "Wagtlayyn_harytlar.xlsx");
  }
}

...
class _TabBarPage2State extends State<TabBarPage2> {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Expanded(
            child: StreamBuilder(
                stream: FirebaseFirestore.instance.collection('products').where('gornusi', isEqualTo: 'products').snapshots(),
                                  ...
                                  : ListView.builder(
                                      ...
                                      itemBuilder: (BuildContext context, int index) {
                                        return TableList(
                                          ...
                                          kgSan: streamSnapshot.data!.docs[index]['san_kg'] == true
                                              ? streamSnapshot.data!.docs[index]['kg'].toString()
                                              : streamSnapshot.data!.docs[index]['san'].toString(),
  ...
  dynamic exportExcel(AsyncSnapshot<QuerySnapshot<Object?>> streamSnapshot) {
    Sheet sheetObject = excel["products".tr];
    ...
    for (int i = 0; i < streamSnapshot.data!.docs.length; i++) {
      ...
      cell4.value = "Harytlar";
    }
    var fileBytes = excel.save(fileName: "Harytlar.xlsx");
  }
}

...
class TabBarPage4 extends StatefulWidget {
  @override
  State<TabBarPage4> createState() => _TabBarPage4State();
}
...
class _TabBarPage4State extends State<TabBarPage4> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('products').where('gornusi', isEqualTo: 'products2').snapshots(),
  ...
  dynamic exportExcel(AsyncSnapshot<QuerySnapshot<Object?>> streamSnapshot) {
    Sheet sheetObject = excel["products2".tr];
    ...
    for (int i = 0; i < streamSnapshot.data!.docs.length; i++) {
      ...
      cell4.value = "Ertir_yuklemeli_harytlar";
    }
    var fileBytes = excel.save(fileName: "Ertir_yuklemeli_harytlar.xlsx");
  }
}
